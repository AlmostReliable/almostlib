...
import com.almostreliable.lib.client.RenderLayerType;
import com.almostreliable.lib.datagen.DataGenHolder;
import com.almostreliable.lib.datagen.DataGenManager;
import com.almostreliable.lib.datagen.provider.BlockStateProvider;
import com.almostreliable.lib.datagen.provider.LootTableProvider;
import com.almostreliable.lib.util.AlmostUtils;
import com.almostreliable.lib.util.ToolType;
...
public class BlockRegistration extends Registration<Block, BlockEntry<? extends Block>> implements DataGenHolder {
     ...
     * <p>
     * Not required if the mod features a {@link com.almostreliable.lib.client.ClientInit} implementation.
